...
namespace ETEditor
{
	...
	{
		private const string protoPath = "Assets/Core/FrameworkExtension/ETNetExtension/ProtoDefine/";
		private const string clientMessagePath = "Assets/Model/Module/Message/";
		private const string hotfixMessagePath = "Assets/Core/FrameworkExtension/ETNetExtension/MessageOutput/";
		...
		public static void Proto2CS(string ns, string protoName, string outputPath, string opcodeClassName, int startOpcode, bool isClient = true)
		{
			...
			sb.Append("using UnityGameFramework.Runtime;\n");
