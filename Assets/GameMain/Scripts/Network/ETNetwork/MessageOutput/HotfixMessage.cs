...
namespace StarForce {
  ...
  public partial class G2C_PlayerInfo : pb::IMessage {
    ...
    private pbc::RepeatedField<global::StarForce.PlayerInfo> playerInfos_ = new pbc::RepeatedField<global::StarForce.PlayerInfo>();
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (playerInfo_ == null) {
              playerInfo_ = new global::StarForce.PlayerInfo();
            }
  ...
  public partial class TestMsg : pb::IMessage {
    private static readonly pb::MessageParser<TestMsg> _parser = new pb::MessageParser<TestMsg>(() => (TestMsg)MessagePool.Instance.Fetch(typeof(TestMsg)));
  ...
  public partial class GFTestMsg : pb::IMessage {
    private static readonly pb::MessageParser<GFTestMsg> _parser = new pb::MessageParser<GFTestMsg>(() => (GFTestMsg)MessagePool.Instance.Fetch(typeof(GFTestMsg)));
